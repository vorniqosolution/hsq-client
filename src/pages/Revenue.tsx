...
const RevenuePage = () => {
  ...
  const renderReportData = () => {
    ...
    // Helper to create a badge based on report type
          ...
          <div className="flex justify-between items-center mb-4 pb-4 border-b border-slate-200">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-light text-slate-900">
                Room Category Revenue ({data.month}/{data.year})
              </h3>
              {getReportBadge()}
            </div>
            <button 
        ...
        <div>
          <div className="flex justify-between items-center mb-4 pb-4 border-b border-slate-200">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-light text-slate-900">
                Discounted Guests ({data.month}/{data.year})
              </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-slate-50 p-3 rounded">
                    ...
                    <div className="text-sm font-medium text-slate-900">
                      {guest.roomCategory} - {guest.roomNumber}
                    </div>
                  </div>
                  <div className="bg-slate-50 p-3 rounded">
        ...
        <div>
          <div className="flex justify-between items-center mb-4 pb-4 border-b border-slate-200">
            <div className="flex items-center space-x-2">
              <Calendar className="h-5 w-5 text-amber-500" />
              <h3 className="text-lg font-light text-slate-900">
                Daily Report ({data.day}/{data.month}/{data.year})
              </h3>
              {getReportBadge()}
            </div>
            <button 
        ...
        <div>
          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-4 rounded-md border border-slate-200 shadow-sm">
                <div className="text-sm text-slate-500 mb-1">Total Guest</div>
                <div className="text-2xl font-light text-slate-900">
                  {data.totalReservations.toLocaleString()}
                </div>
              </div>
    ...
    return <p>Could not determine report type.</p>;
  };
