...
//     if (!revenueByCategory || !revenueByCategory.data) return [];
...
//     if (!compareRevenue || !compareRevenue.data) return [];
...
//     if (!occupancyAnalytics || !occupancyAnalytics.data) return [];
...
//     if (!paymentMethodsRevenue || !paymentMethodsRevenue.paymentBreakdown) return [];
...
//                           {compareRevenue ? compareRevenue.summary.totalRevenueFormatted : 'N/A'}
//                         </p>
//                       )}
//                     </div>
...
//                   {/* YoY comparison would require historical data that isn't in the API response */}
...
//                       ) : (
//                         <p className="text-3xl font-light mt-2 text-slate-900">
//                           {occupancyAnalytics ? occupancyAnalytics.summary.averageOccupancyRateFormatted : 'N/A'}
//                         </p>
//                       )}
//                     </div>
...
//                     {occupancyAnalytics ? `${occupancyAnalytics.summary.totalGuests} total guests` : 'Loading...'}
//                   </p>
//                 </CardContent>
//               </Card>
...
//                       ) : (
//                         <p className="text-3xl font-light mt-2 text-slate-900">
//                           {occupancyAnalytics ? occupancyAnalytics.summary.averageRevPARFormatted : 'N/A'}
//                         </p>
//                       )}
//                     </div>
...
//                   <div className="flex justify-between items-start">
//                     <div>
//                       <p className="text-sm font-medium text-slate-500">Top Payment Method</p>
//                       {loading ? (
//                         <Skeleton className="h-8 w-32 mt-2" />
//                       ) : (
//                         <p className="text-3xl font-light mt-2 text-slate-900">
//                           {paymentMethodsRevenue && paymentMethodsRevenue.paymentBreakdown.length > 0 ? 
//                             paymentMethodsRevenue.paymentBreakdown[0].paymentMethod.charAt(0).toUpperCase() + 
//                             paymentMethodsRevenue.paymentBreakdown[0].paymentMethod.slice(1) : 
//                             'N/A'
//                           }
//                         </p>
//                       )}
...
//                   <p className="text-sm text-slate-500 mt-4">
//                     {paymentMethodsRevenue && paymentMethodsRevenue.paymentBreakdown.length > 0 ? 
//                       `${paymentMethodsRevenue.paymentBreakdown[0].percentageFormatted} of transactions` : 
//                       'Loading...'
//                     }
//                   </p>
//                 </CardContent>
...
//                                   style={{ 
//                                     width: `${(item.totalRevenue / compareRevenue.summary.totalRevenue) * 100}%`,
//                                     backgroundColor: getCategoryColor(item.category)
//                                   }}
//                                 />
//                               </div>
//                               <p className="text-xs text-slate-500 mt-1">
//                                 {((item.totalRevenue / compareRevenue.summary.totalRevenue) * 100).toFixed(1)}% of total
//                               </p>
//                             </div>
//                           ))}
//                         </div>
...
//                               {revenueByCategory.summary.totalRevenueFormatted}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {revenueByCategory.summary.totalGuests}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {revenueByCategory.summary.averageRevenuePerGuestFormatted}
//                             </td>
...
//                               </td>
//                               <td className="py-4 px-6 text-right font-medium text-slate-800">
//                                 {((item.totalRevenue / compareRevenue.summary.totalRevenue) * 100).toFixed(1)}%
//                               </td>
//                             </tr>
//                           ))}
//                         </tbody>
...
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {compareRevenue.summary.totalRevenueFormatted}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {compareRevenue.summary.totalGuests}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {compareRevenue.summary.totalRooms}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {compareRevenue.summary.totalGuests ? 
...
//                                   style={{ width: `${Math.min(occupancyAnalytics.summary.averageOccupancyRate, 100)}%` }}
//                                 >
//                                   {occupancyAnalytics.summary.averageOccupancyRate > 15 ? 
...
//                               <p className="text-2xl font-light text-slate-900">{occupancyAnalytics.summary.totalRooms}</p>
//                             </div>
//                             <div>
//                               <p className="text-sm text-slate-500 mb-1">Total Guests</p>
//                               <p className="text-2xl font-light text-slate-900">{occupancyAnalytics.summary.totalGuests}</p>
//                             </div>
//                           </div>
                          
//                           <div>
//                             <p className="text-sm text-slate-500 mb-1">Average RevPAR</p>
//                             <p className="text-2xl font-light text-slate-900">{occupancyAnalytics.summary.averageRevPARFormatted}</p>
//                             <p className="text-xs text-slate-500 mt-1">Revenue per Available Room</p>
//                           </div>
                          
//                           <div>
//                             <p className="text-sm text-slate-500 mb-1">Total Revenue</p>
//                             <p className="text-2xl font-light text-slate-900">{occupancyAnalytics.summary.totalRevenueFormatted}</p>
//                           </div>
//                         </div>
//                       ) : (
...
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">-</td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {occupancyAnalytics.summary.totalRooms} rooms
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {occupancyAnalytics.summary.totalGuests} total
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {occupancyAnalytics.summary.totalRevenueFormatted}
//                             </td>
//                             <td className="py-4 px-6 text-right font-medium text-slate-800">
//                               {occupancyAnalytics.summary.averageRevPARFormatted}
//                             </td>
//                           </tr>
//                         </tfoot>
//                       </table>
...
//                               {paymentMethodsRevenue.summary.totalRevenueFormatted}
//                             </p>
//                           </div>
...
//                             <p className="text-sm text-slate-500 mb-1">Total Guests</p>
//                             <p className="text-2xl font-light text-slate-900">
//                               {paymentMethodsRevenue.summary.totalGuests}
//                             </p>
//                           </div>
...
//                             <p className="text-2xl font-light text-slate-900">
//                               {paymentMethodsRevenue.summary.averageTransactionAmountFormatted}
//                             </p>
//                           </div>
...
//                             <p className="text-2xl font-light text-slate-900">
//                               {paymentMethodsRevenue.summary.paymentMethodsUsed}
//                             </p>
//                           </div>
//                         </div>
//                       ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <Card className="border-0 shadow-lg bg-white">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      {loading ? (
                        ...
                        <p className="text-3xl font-light mt-2 text-slate-900">
                          {/* FIX: Use optional chaining on the array access */}
                          {paymentMethodsRevenue?.paymentBreakdown?.[0]?.paymentMethod.charAt(0).toUpperCase() + 
                           paymentMethodsRevenue?.paymentBreakdown?.[0]?.paymentMethod.slice(1) ?? 'N/A'}
                        </p>
                      )}
                    </div>
                    <div className="p-3 bg-purple-100 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500 mt-4">
                    {/* FIX: Use optional chaining on the array access */}
                    {paymentMethodsRevenue?.paymentBreakdown?.[0] ? 
                      `${paymentMethodsRevenue.paymentBreakdown[0].percentageFormatted} of transactions` : 
                      'Loading...'
                    }
                  </p>
