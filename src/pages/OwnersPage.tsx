...
const OwnersPage = () => {
    ...
    const OwnerForm = ({ onSubmit, submitLabel }: { onSubmit: (e: React.FormEvent) => void, submitLabel: string }) => (
        ...
        <div className="min-h-screen bg-slate-50 p-6 md:p-10">
            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                    ...
                    <OwnerForm onSubmit={handleCreateSubmit} submitLabel="Create Owner" />
                </DialogContent>
            </Dialog>
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                    ...
                    <OwnerForm onSubmit={handleEditSubmit} submitLabel="Update Owner" />
                </DialogContent>
            </Dialog>
