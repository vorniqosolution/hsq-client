    ...
    try {
      if (itemForm._id) {
        ...
        await updateItem(itemForm._id, {
          ...
          defaultCheckInQty:
            parseInt(itemForm.defaultCheckInQty as string) || 0,
        });
      } else {
        // Create new item
        await createItem({
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
              <div>
                ...
                <p className="text-slate-600 mt-2 font-light">
                  Track and manage property supplies and stock levels
                </p>
              </div>
                  ...
                  <Card className="border-0 shadow-lg bg-white">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-slate-500 mt-4">
                        {filteredInventory.length} items in view
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-lg bg-white lg:col-span-2">
                    <CardHeader>
                      ...
                      <CardDescription className="font-light text-slate-500">
                        Inventory levels over the past 6 months
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="border-0 shadow-lg bg-white overflow-hidden">
                  <CardHeader className="pb-4 border-b bg-slate-50 flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                    <div>
                      ...
                      <CardDescription className="font-light text-slate-500">
                        Complete list of supplies and stock
                      </CardDescription>
                    </div>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-slate-100">
                          ...
                          <th className="text-center py-4 px-6 text-sm font-medium text-slate-500">
                            Default Qty
                          </th>
                          <th className="text-right py-4 px-6 text-sm font-medium text-slate-500">
                            Actions
                  ...
                  <CardContent className="p-6 border-t">
                    <div className="flex justify-between items-center">
                      <p className="text-sm text-slate-500">
                        Showing {filteredInventory.length} of {items.length}{" "}
                        items
                      </p>
                      ...
                      <CardContent>
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-slate-600">
                            {/* FIX: Safely filter items, checking for null category objects. */}
                            {
                              items.filter((item) =>
                                typeof item.category === "object" &&
                                item.category
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setItemForm({ ...itemForm, quantityOnHand: e.target.value })
                }
                className="col-span-3"
              />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setItemForm({ ...itemForm, reorderLevel: e.target.value })
                }
                className="col-span-3"
              />
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setItemForm({
                    ...itemForm,
                    defaultCheckInQty: e.target.value,
                  })
                }
                className="col-span-3"
              />
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setTransactionForm({ ...transactionForm, item: value })
                }
              >
                <SelectTrigger className="col-span-3">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-medium">{deleteItemInfo.name}</span>.
              {deleteItemInfo.type === "category" &&
                " All items in this category will need to be reassigned."}
