...
const InventoryPage = () => {
  ...
  const handleEditItem = (item: InventoryItem) => {
    setItemForm({
      ...
      category: (typeof item.category === 'object' && item.category) ? item.category._id : String(item.category || ''),
                          ...
                          <tr key={item._id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                            ...
                            <td className="py-4 px-6">
                              <Badge className="capitalize bg-slate-100 text-slate-800 hover:bg-slate-200">
                                ...
                                {typeof item.category === 'object' && item.category ? item.category.name : 'Uncategorized'}
                              </Badge>
                            </td>
