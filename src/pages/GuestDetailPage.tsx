...
// const InvoiceCard = ({ invoice, guest, onPrint, onSendEmail, isSendingEmail }) => {
...
//             <FileText className="mr-2 h-5 w-5 text-primary print:hidden" />
...
//               <span className="font-medium flex items-center">
//                 <Percent className="h-4 w-4 mr-1 opacity-70" /> Standard Discount:
//               </span>
...
//             <div className="flex justify-between text-emerald-600 dark:text-emerald-400">
//               <span className="font-medium flex items-center">
//                 <Percent className="h-4 w-4 mr-1 opacity-70" /> Additional Discount:
//               </span>
...
//                 <Percent className="h-4 w-4 mr-1 opacity-70" /> Total Discount:
//               </span>
...
//           <div className="flex justify-between text-slate-600 dark:text-slate-400">
//             <span className="font-medium flex items-center">
//               <PieChart className="h-4 w-4 mr-1 opacity-70" /> Tax ({invoice.taxRate}%):
//             </span>
...
//       <CardFooter className="bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end space-x-2 print:hidden">
...
//             <Card className="overflow-hidden border-slate-200 dark:border-slate-700 print:shadow-none print:border-0">
//               <CardHeader className="bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 border-b border-slate-200 dark:border-slate-700 print:pb-2">
//                 <div className="flex items-center justify-between">
//                   <CardTitle className="flex items-center text-slate-800 dark:text-slate-200">
//                     <User className="mr-2 h-5 w-5 text-primary print:hidden" />
//                     <span className="print:text-xl">Guest Information</span>
//                   </CardTitle>
                  
//                   <Badge className={`${getStatusColor(guest.status)} print:hidden`}>
//                     {guest.status === "checked-in" ? "Currently Staying" : "Checked Out"}
//                   </Badge>
//                 </div>
//                 <CardDescription className="text-slate-500 dark:text-slate-400 print:hidden">
//                   Personal and contact details
//                 </CardDescription>
//               </CardHeader>

//               <CardContent className="grid md:grid-cols-2 gap-6 pt-6 print:gap-2 print:text-sm">
//                 <div className="space-y-3">
//                   <div className="flex items-start">
//                     <User className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//                   <div className="flex items-start">
//                     <FileText className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//                   <div className="flex items-start">
//                     <Home className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//                 <div className="space-y-3">
//                   <div className="flex items-start">
//                     <Phone className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//                   {guest.email && (
//                     <div className="flex items-start">
//                       <Mail className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                       <div>
...
//                   <div className="flex items-start">
//                     <CreditCard className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//               <CardHeader className="bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 border-b border-slate-200 dark:border-slate-700 print:pb-2">
//                 <CardTitle className="flex items-center text-slate-800 dark:text-slate-200">
//                   <Clock className="mr-2 h-5 w-5 text-primary print:hidden" />
...
//                   <div className="flex items-start">
//                     <Tag className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//                 <div className="space-y-3">
//                   <div className="flex items-start">
//                     <Calendar className="h-4 w-4 mr-2 mt-1 text-slate-400 print:hidden" />
//                     <div>
...
//             {/* Print-only footer */}
//             <div className="hidden print:block mt-12 pt-6 border-t text-center text-sm text-slate-600">
