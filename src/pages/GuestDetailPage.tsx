...
import { 
  ArrowLeft, Edit, LogOut, Printer, Send, User, Phone, FileText, Clock, DollarSign 
} from 'lucide-react';
    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="min-h-[500px]" ref={printRef}>
        ...
        <div className="hidden print:block text-center mb-8">
          ...
          <p className="text-gray-500">Tel: +92 330 0491479 | Email: hsqtower@gmail.com</p>
          {invoice && (
          ...
          <div className="space-y-6">
            ...
            <Card className="print:shadow-none print:border-0">
              <CardHeader className="print:pb-2">
                ...
                <CardDescription className="print:hidden">Personal and contact details</CardDescription>
              </CardHeader>
            ...
            <div className="hidden print:block mt-8 pt-4 border-t text-center text-sm text-gray-500">
              ...
              <p>For any inquiries regarding this invoice, please contact our accounting department.</p>
              <p className="mt-4 font-bold">
                {guest.status === 'checked-out' 
                  ? 'PAID IN FULL' 
                  : `BALANCE DUE: Rs${invoice?.grandTotal.toLocaleString() || guest.totalRent.toLocaleString()}`}
              </p>
            </div>
          </div>
        )}
