...
const RoomsPage = () => {
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      toast({ title: 'Room created', description: `Room ${formData.roomNumber} has been created.` });
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Create a new room for your hotel</DialogDescription>
              </DialogHeader>
              <form onSubmit={handleCreateSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={formData.bedType} onValueChange={(val) => setFormData({ ...formData, bedType: val })}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={formData.view} onValueChange={(val) => setFormData({ ...formData, view: val })}>
                      <SelectTrigger><SelectValue /></SelectTrigger>
                      <SelectContent>
                        <SelectItem value="Lobby Facing">Lobby Facing</SelectItem>
                        <SelectItem value="Terrace View">Terrace View</SelectItem>
          ...
          {rooms.map((room) => (
            <Card key={room._id} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>{room.dropdownLabel || `${room.bedType} ${room.category} ${room.view}`}</CardDescription>
              </CardHeader>
              <CardContent>
