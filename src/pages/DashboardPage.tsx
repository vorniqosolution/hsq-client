          ...
          {reservedRoomsByDate && reservedRoomsByDate.length > 0 ? (
            reservedRoomsByDate.map((reservation) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-slate-700">
                  {reservation.daysBooked} {reservation.daysBooked === 1 ? 'day' : 'days'}
                </td>
              </tr>
            ))
          ) : (
...
const DashboardPage = () => {
  ...
  const roomStatusData = React.useMemo(() => {
    const { availableRooms, occupiedRooms, reservedRooms, maintenanceRooms } = filteredRooms;
    return [
  ...
  }, [fetchRooms, fetchGuests, fetchReservedRoomsByDate, selectedMonth, selectedYear]);
      ...
      <div className="flex-1 lg:ml-0 overflow-hidden">
        ...
        <div className="p-8 h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
              ...
              <Card className="border-0 shadow-lg bg-white lg:col-span-2">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 flex items-center justify-between border-t pt-4">
                    <p className="text-sm text-slate-600 font-light">
                      Showing {filteredRooms.formattedRooms.length} of {rooms.length} rooms
                    </p>
                    <Link to="/rooms">
                      <Button
                        variant="outline"
            ...
            <div className="mb-10" style={{ height: '400px' }}> {/* Fixed height container */}
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="font-light text-slate-500">
                        Reserved rooms for {new Date(selectedYear, selectedMonth - 1).toLocaleString('default', { month: 'long' })} {selectedYear}
                      </CardDescription>
                    </div>
                    <div className="flex items-center space-x-2">
