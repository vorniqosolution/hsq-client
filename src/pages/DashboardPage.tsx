...
const DashboardPage = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      trend:
        occupiedRooms > availableRooms ? ("up" as const) : ("down" as const),
      icon: Users,
            ...
            <Card className="border-0 shadow-lg bg-white">
              ...
              <CardContent>
                <div className="space-y-3">
                      ...
                      >
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500 font-light">
                              {guest.room?.type
                                ? `${
                                    guest.room.type.charAt(0).toUpperCase() +
                                    guest.room.type.slice(1)
                                  } Suite`
                                : "Suite"}{" "}
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-slate-400 font-light mt-0.5">
                            {new Date(guest.checkInDate).toLocaleTimeString(
                              "en-US",
                              {
                                hour: "2-digit",
                                minute: "2-digit",
                  ...
                  {guests.filter((guest) => !guest.checkOutDate).length ===
                    0 && (
