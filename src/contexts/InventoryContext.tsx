...
interface InventoryContextType {
  ...
  setDefaultCheckInQuantity: (itemId: string, quantity: number) => Promise<void>;
...
export const InventoryProvider = ({ children }: { children: ReactNode }) => {
  ...
  const fetchCategories = useCallback(async () => {
    await apiCall(
      async () => {
        const response = await apiClient.get<{ data: InventoryCategory[] }>('/api/inventory/get-categories');
  ...
  const createCategory = useCallback(async (data: CreateCategoryInput) => {
    await apiCall(
      async () => {
        const response = await apiClient.post<{ data: InventoryCategory }>('/api/inventory/create-category', data);
        return response.data.data;
      },
      (newCategory) => {
  ...
  const updateCategory = useCallback(async (id: string, data: Partial<CreateCategoryInput>) => {
    await apiCall(
      async () => {
        const response = await apiClient.put<{ data: InventoryCategory }>(`/api/inventory/update-category/${id}`, data);
        return response.data.data;
      },
      (updatedCategory) => {
  ...
  const fetchItems = useCallback(async () => {
    await apiCall(
      async () => {
        const response = await apiClient.get<{ data: InventoryItem[] }>('/api/inventory/get-items');
        return response.data.data;
      },
      (data) => setItems(data),
  ...
  const createItem = useCallback(async (data: CreateItemInput) => {
    await apiCall(
      async () => {
        const response = await apiClient.post<{ data: InventoryItem }>('/api/inventory/create-item', data);
        return response.data.data;
      },
      (newItem) => {
  ...
  const updateItem = useCallback(async (id: string, data: Partial<CreateItemInput>) => {
    await apiCall(
      async () => {
        const response = await apiClient.put<{ data: InventoryItem }>(`/api/inventory/update-item/${id}`, data);
        return response.data.data;
      },
      (updatedItem) => {
  ...
  const setDefaultCheckInQuantity = useCallback(async (itemId: string, quantity: number) => {
    await apiCall(
      async () => {
  ...
  const fetchTransactions = useCallback(async () => {
    await apiCall(
      async () => {
        const response = await apiClient.get<{ data: InventoryTransaction[] }>('/api/inventory/get-transactions');
        return response.data.data;
      },
  ...
  const createTransaction = useCallback(async (data: CreateTransactionInput) => {
    await apiCall(
      async () => {
        const response = await apiClient.post<{ data: InventoryTransaction }>('/api/inventory/create-transaction', data);
        return response.data.data;
      },
      (newTransaction) => {
        ...
        setItems(prev => prev.map(item => {
          if (item._id === itemId) {
            const quantityChange = 
              data.transactionType === 'issue' || data.transactionType === 'usage'
                ? -quantity
                : quantity;
  ...
  const getTransactionsForRoom = useCallback(async (roomId: string) => {
    return await apiCall(
      async () => {
        const response = await apiClient.get<{ data: InventoryTransaction[] }>(`/api/inventory/get-transactions?room=${roomId}`);
        return response.data.data;
      },
      undefined,
  ...
  const getTransactionsForGuest = useCallback(async (guestId: string) => {
    return await apiCall(
      async () => {
        const response = await apiClient.get<{ data: InventoryTransaction[] }>(`/api/inventory/get-transactions?guest=${guestId}`);
        return response.data.data;
      },
      undefined,
  ...
  const handleRoomCheckin = useCallback(async (roomId: string, guestId: string) => {
    await apiCall(
      async () => {
  ...
  const handleRoomCheckout = useCallback(async (roomId: string, guestId: string) => {
    await apiCall(
      async () => {
