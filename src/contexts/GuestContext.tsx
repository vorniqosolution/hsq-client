...
//   const fetchGuestsByCategory = async (category: string) => {
//     setLoading(true);
//     setError(null);
//     try {
//       const res = await axios.get<{ data: Guest[] }>(
//         `${API_BASE}/api/guests/get-guest-by-category?category=${encodeURIComponent(category)}`,
//         { withCredentials: true }
//       );
...
//     setError(null);
//     try {
//       const res = await axios.get<{ data: { guest: Guest; invoice: Invoice | null } }>(
...
//     setError(null);
//     try {
//       await axios.delete(`${API_BASE}/api/guests/guests/${id}`, { withCredentials: true });
//       await fetchGuests();
//     } catch (err: any) {
//       setError(err.message);
//       throw err;
...
//     window.open(`${API_BASE}/api/invoices/${invoiceId}/download`, '_blank');
//   };
...
//     setError(null);
//     try {
//       await axios.post(`${API_BASE}/api/invoices/${invoiceId}/send-email`, {}, { withCredentials: true });
//     } catch (err: any) {
//       setError(err.message);
//       throw err;
//     } finally {
